...
export const translations = {
  uz: {
    ...
    library: {
      badge: "18 ta mavzu",
      title: "Matematik",
      titleHighlight: "Kutubxona",
      subtitle: "Matematik analiz va differensial tenglamalar bo'yicha to'liq nazariy materiallar",
    },
    // Tests Page
    tests: {
      title: "Matematika",
      titleHighlight: "Testlari",
      subtitle: "Bilimingizni sinab ko'ring! Turli mavzular bo'yicha interaktiv testlar",
      stats: {
        tests: "Testlar",
        questions: "Savollar",
    ...
    // Formulas Page
    formulas: {
      title: "Matematik Formulalar",
      subtitle: "Algebra, geometriya, trigonometriya va boshqa mavzular bo'yicha barcha kerakli formulalar bir joyda",
      searchPlaceholder: "Formula qidirish...",
      noFormulasFound: "bo'yicha formulalar topilmadi",
    },
    // Graphics Page
    graphics: {
      title: "Funksiya",
      titleHighlight: "Grafigi",
      subtitle: "Matematik funksiyalarni interaktiv tarzda vizualizatsiya qiling",
      addFunction: "Qo'shish",
      reset: "Qayta boshlash",
      enterFormula: "Formula kiriting (masalan: sin(x), x^2)",
      zoom: "Masshtab",
      functionAnalysis: "Funksiya tahlili",
      roots: "Ildizlar (f(x)=0)",
      intersections: "Kesishish nuqtalari",
      derivative: "Hosilasi",
      integral: "Integral",
      showIntegral: "Integralni ko'rsatish",
      integralFrom: "dan",
      integralTo: "gacha",
      integralValue: "Integral qiymati",
      pointOnGraph: "Grafikdagi nuqta",
      enterX: "X qiymatini kiriting",
      calculate: "Hisoblash",
  ...
  en: {
    ...
    library: {
      ...
      subtitle: "Complete theoretical materials on calculus and differential equations",
    },
    // Tests Page
    tests: {
      title: "Math",
      titleHighlight: "Tests",
      subtitle: "Test your knowledge! Interactive tests on various topics",
      stats: {
        tests: "Tests",
        questions: "Questions",
        completed: "Completed",
    ...
    formulas: {
      title: "Math Formulas",
      subtitle: "All essential formulas for algebra, geometry, trigonometry and more in one place",
      searchPlaceholder: "Search formulas...",
      noFormulasFound: "No formulas found for",
    },
    // Graphics Page
    graphics: {
      title: "Function",
      titleHighlight: "Graph",
      subtitle: "Visualize mathematical functions interactively",
      addFunction: "Add",
      reset: "Reset",
      enterFormula: "Enter formula (e.g.: sin(x), x^2)",
      zoom: "Zoom",
      ...
      integral: "Integral",
      showIntegral: "Show Integral",
      integralFrom: "from",
      integralTo: "to",
      integralValue: "Integral Value",
      pointOnGraph: "Point on Graph",
