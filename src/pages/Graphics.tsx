...
import { Search, LineChart, MousePointer2, Move, ZoomIn } from "lucide-react";
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative w-full max-w-md">
            ...
            <Input
              placeholder="Vizualizatsiya qidirish..."
              value={searchQuery}
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-semibold">2D Vizualizatsiyalar</h2>
              <span className="text-sm text-muted-foreground">({filtered2D.length})</span>
            </div>
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-3 gap-4">
          <div className="bg-card rounded-lg p-4 border border-border text-center">
            ...
            <div className="text-sm text-muted-foreground">Vizualizatsiyalar</div>
          </div>
          <div className="bg-card rounded-lg p-4 border border-border text-center">
